...
const DashboardLayout = ({ children }: { children: React.ReactNode }) => {
    ...
    return (
        <div className="h-screen h-dvh flex w-full overflow-hidden relative overscroll-none">
            <Sidebar isCollapsed={isCollapsed} />
            <div className="flex-1 flex flex-col h-full min-w-0 overflow-y-auto relative overscroll-contain">
                <header className="flex items-center justify-between px-8 py-5 border-b border-border bg-card shrink-0" role="banner">
