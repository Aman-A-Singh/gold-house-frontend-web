            ...
            <DialogContent className="sm:max-w-xl max-h-[85vh] overflow-y-auto">
                ...
                <div className="space-y-4 py-2">
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <label htmlFor="add-weight" className={`text-xs font-medium mb-1.5 block ${errors.result ? "text-destructive" : "text-muted-foreground"}`}>Result (g) *</label>
